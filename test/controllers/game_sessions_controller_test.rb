...
class GameSessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create game_session" do
    assert_difference("GameSession.count") do
      post game_sessions_url, params: { game_session: { date: @game_session.date, players_per_team: @game_session.players_per_team, status: @game_session.status } }
    end
  ...
  test "should update game_session" do
    patch game_session_url(@game_session), params: { game_session: { date: @game_session.date, players_per_team: @game_session.players_per_team, status: @game_session.status } }
